...
use Zonapro\WedContest\Shortcodes\ShortcodesInterface;
class RegisterRepresentant implements ShortcodesInterface{
 	...
 	*/
 	public static function show($atts){
 		extract(shortcode_atts(array(
                ...
                'title' =>__('Register Form','wedcontest')
                    ), $atts));
 		ob_start();?>
 		<h3 style="text-align: center; color: #333333;" ><?= $title ?></h3>
 		<form action="<?php echo  admin_url( 'admin-post.php' )?>" method="POST" accept-charset="utf-8" id="register_form">
 			...
 			<select name="country" required>
 				...
 				<option value="<?php _e($key,'wedocntest') ?>"><?php _e($country,'wedocntest') ?></option>
 				<?php } ?>
 			</select>
 			...
 			<select name="referral" required>
 				...
 				<option value="diprounduca"><?php _e("I'm a guest of diproinduca ","wedcontest")?></option>
 				<option value="relative"><?php _e('I am invited by a relative or contact in Diproinduca','wedcontest')?></option>
 				<option value="other"><?php _e('Other, please specify:','wedcontest')?></option>
 			</select>
