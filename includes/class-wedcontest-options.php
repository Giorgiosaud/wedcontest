...
class WedContest_Options {
    ...
    public function add_plugin_page()
    {
	    ...
	    add_submenu_page( 'wedcontest','Wedcontest Settings', 'Wedcontest Webhook Setup', 'manage_options', 'wedcontest' ,array( $this, 'create_admin_page' ));
	    add_submenu_page( 'wedcontest','Wedcontest Webhook Settings', 'Wedcontest Webhook Setup', 'manage_options', 'wedcontest_webhook' ,array( $this, 'create_webhook_admin_page' ));
     ...
     * Options page callback
     */
    public function create_webhook_admin_page()
    {
        // Set class property
    	$this->options = get_option( 'wedcontest' );
    	?>
    	<div class="wrap">
    		...
    		<form method="post" action="options.php">
                ...
                // This prints out all hidden setting fields
    			settings_fields( 'wedcontest_settings' );
    			do_settings_sections( 'wedcontest_webhook' );
    			submit_button();
    			?>
    		</form>
    	</div>
