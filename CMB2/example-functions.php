 ...
 *
 * Be sure to replace all instances of 'zonapro_wedcontest_' with your project's prefix.
 ...
 */
function zonapro_wedcontest_show_if_front_page( $cmb ) {
 ...
 * @return bool                     True if metabox should show
 */
function zonapro_wedcontest_hide_if_no_cats( $field ) {
 ...
 */
function zonapro_wedcontest_render_row_cb( $field_args, $field ) {
 ...
 * @param  CMB2_Field $field      The field object.
 */
function zonapro_wedcontest_display_text_small_column( $field_args, $field ) {
	?>
 ...
 * @param  CMB2_Field object $field      Field object.
 */
function zonapro_wedcontest_before_row_if_2( $field_args, $field ) {
...
add_action( 'cmb2_admin_init', 'zonapro_wedcontest_register_demo_metabox' );
/**
 * Hook in and add a demo metabox. Can only happen on the 'cmb2_admin_init' or 'cmb2_init' hook.
 */
function zonapro_wedcontest_register_demo_metabox() {
	$prefix = 'zonapro_wedcontest_demo_';
	...
	$cmb_demo->add_field( array(
		...
		'id'         => $prefix . 'text',
		'type'       => 'text',
		'show_on_cb' => 'zonapro_wedcontest_hide_if_no_cats', // function should return a bool value
	...
	$cmb_demo->add_field( array(
		...
		// );
		// 'display_cb' => 'zonapro_wedcontest_display_text_small_column', // Output the display of the column values through a callback.
	) );
	...
	$cmb_demo->add_field( array(
		...
		'type' => 'text',
		'render_row_cb' => 'zonapro_wedcontest_render_row_cb',
	) );
	...
	$cmb_demo->add_field( array(
		...
		'type'         => 'text',
		'before_row'   => 'zonapro_wedcontest_before_row_if_2', // callback.
...
add_action( 'cmb2_admin_init', 'zonapro_wedcontest_register_about_page_metabox' );
/**
 * Hook in and add a metabox that only appears on the 'About' page
 */
function zonapro_wedcontest_register_about_page_metabox() {
	$prefix = 'zonapro_wedcontest_about_';
...
add_action( 'cmb2_admin_init', 'zonapro_wedcontest_register_repeatable_group_field_metabox' );
/**
 * Hook in and add a metabox to demonstrate repeatable grouped fields
 */
function zonapro_wedcontest_register_repeatable_group_field_metabox() {
	$prefix = 'zonapro_wedcontest_group_';
...
add_action( 'cmb2_admin_init', 'zonapro_wedcontest_register_user_profile_metabox' );
/**
 * Hook in and add a metabox to add fields to the user profile pages
 */
function zonapro_wedcontest_register_user_profile_metabox() {
	$prefix = 'zonapro_wedcontest_user_';
...
add_action( 'cmb2_admin_init', 'zonapro_wedcontest_register_taxonomy_metabox' );
/**
 * Hook in and add a metabox to add fields to taxonomy terms
 */
function zonapro_wedcontest_register_taxonomy_metabox() {
	$prefix = 'zonapro_wedcontest_term_';
...
add_action( 'cmb2_admin_init', 'zonapro_wedcontest_register_theme_options_metabox' );
/**
 * Hook in and register a metabox to handle a theme options page and adds a menu item.
 */
function zonapro_wedcontest_register_theme_options_metabox() {

	/**
	 * Registers options page menu item and form.
	 */
	$cmb_options = new_cmb2_box( array(
		'id'           => 'zonapro_wedcontest_theme_options_page',
		...
		'option_key'      => 'zonapro_wedcontest_theme_options', // The option key and admin menu page slug.
 ...
 */
function zonapro_wedcontest_limit_rest_view_to_logged_in_users( $is_allowed, $cmb_controller ) {
...
add_action( 'cmb2_init', 'zonapro_wedcontest_register_rest_api_box' );
/**
 ...
 */
function zonapro_wedcontest_register_rest_api_box() {
	$prefix = 'zonapro_wedcontest_rest_';
	...
	$cmb_rest = new_cmb2_box( array(
		...
		// 'get_box_permissions_check_cb' => 'zonapro_wedcontest_limit_rest_view_to_logged_in_users',
	) );
